...
for i = 1:numel(chamberPressureValues)
    for j = 1:numel(nozzleHeightValues)
        ...
        figure;
        hold on;
        plot(currentTable.FlowRate_gs_, currentTable.Diameter_mm_, 'go', 'DisplayName', 'Diameter');
        hold off;
...
for i = 1:numel(chamberPressureValues)
    for j = 1:numel(flowRateValues)
        ...
        figure;
        hold on;
        plot(currentTable.NozzleHeight_h_D_, currentTable.Diameter_mm_, 'go', 'DisplayName', 'Diameter');
        hold off;
...
for i = 1:numel(nozzleHeightValues)
    for j = 1:numel(flowRateValues)
        ...
        figure;
        hold on;
        plot(currentTable.ChamberPressure_mTorr_, currentTable.Diameter_mm_, 'go', 'DisplayName', 'Diameter');
        hold off;
