...
folder_index = [4 1]; %50mTorr 6Torr h15 8.6g/s
% folder_index = [12 13 14 15 16 17]
...
% legend('repetion 2','repetion 3','repetion 4','repetion 5','repetion 6','repetion 7') %50Torr h10 8.6g/s
